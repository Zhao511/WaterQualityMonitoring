...
│ Turbidity  │ ATK-  │ HMAC认证 │         │ 命令路由  │ HTTP  │ (Bootstrap)│
...
| **Water_status** | tds, pH, temp, turbidity, rfid, gps | set_report_interval, set_threshold, calibrate_sensor, led_control, request_immediate_report |
...
- **传感器**：pH(PA0), TDS电导率(PA1), Turbidity浊度(PA2), NTC温度(PA3)
